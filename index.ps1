...
do {
    ...
    switch ($key) {
        ...
        'D2' {
            ...
            winget uninstall 9mssgkg348sp  -h --accept-source-agreements
            winget uninstall 9p1j8s7ccwwt  -h --accept-source-agreements
            winget uninstall 9nblggh5r558  -h --accept-source-agreements
            winget uninstall 9wzdncrfj4q7  -h --accept-source-agreements
            winget uninstall 9nht9rb2f4hd  -h --accept-source-agreements
            Start-Sleep -seconds 1
